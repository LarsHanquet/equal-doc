...
* As you can see, we're using a *[DBMS relationship](https://afteracademy.com/blog/what-are-the-different-types-of-relationships-in-dbms)*, linking `user_id` with `tasks_ids`. This is also handled by the framework; all you have to know is the definition syntax (see [**Basics > Objects parameters**](TODO)).
...
- As you can see we're using a *[DBMS relationship](https://afteracademy.com/blog/what-are-the-different-types-of-relationships-in-dbms)*, linking `user_id` with `tasks_ids`. This is also handled by the framework, all you have to know is the definition syntax (see [**Basics > Objects parameters**](TODO))
<!---TODO update link towards basics > object > parameters-->
