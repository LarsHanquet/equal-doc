...
| checkbox     | `boolean`  |                 |
| select       | `many2one` | default: inline selection with typeahead, with the possibility of new context for creation or advanced selection |
| list         | `one2many` | default         |
| multiselect  | `one2many` | multi-select input view |
| list         | `many2many`| default         |
| multiselect  | `many2many`| multi-select input view |
